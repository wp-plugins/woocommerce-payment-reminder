	...
	*/
	...
	if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
		...
		function get_lng_wpr($text='') {
			...
			if ( get_bloginfo("language") === "fa-IR" ) {
				$lng = array(
					...
					'alert_recommend' => 'پیشنهاد می‌کنیم افزونه <a href="https://wordpress.org/plugins/woocommerce-count-orders-in-adminbar/" target="_blank">«نمایش تعداد سفارشات در انتظار تحویل»</a> را نصب کنید.',
				...
				$lng = array(
					...
					'alert_recommend' => 'We recommend you install <a href="https://wordpress.org/plugins/woocommerce-count-orders-in-adminbar/" target="_blank">WooCommerce Pending Orders in AdminBar</a> ...',	
		...
		function wc_pr_admin_notice() {
			?>
			<div class="updated"> 
				<p><?= get_lng_wpr('alert_recommend'); ?></p>
			</div>
			<?php
		}
